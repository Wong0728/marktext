...
export const getOpenInNewWindow = () => ({
  label: t('contextMenu.tabs.openInNewWindow'),
  id: 'openInNewWindow',
  click(menuItem: TabMenuItem, _browserWindow?: unknown) {
    contextMenu.openInNewWindow(menuItem._tabId)
  }
})
...
export const OPEN_IN_NEW_WINDOW = getOpenInNewWindow()

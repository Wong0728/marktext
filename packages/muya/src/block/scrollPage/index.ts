...
export class ScrollPage extends Parent {
    ...
    private _activeStatusRafId: number | null = null;
    ...
    handleBlurFromContent(block: Content) {
        ...
        this._activeStatusRafId = requestAnimationFrame(this._updateActiveStatus);
    }
    ...
    destroy() {
        if (this._activeStatusRafId !== null) {
            cancelAnimationFrame(this._activeStatusRafId);
            this._activeStatusRafId = null;
        }
    }
